...
C     Original AS 176 for kde
      SUBROUTINE DENEST(DT, NDT, DLO, DHI, WINDOW, FT, SMOOTH,
     *      NFT, ICAL, IFAULT)
      double precision DT(NDT), FT(NFT), SMOOTH(NFT), STEP, 
     *       AINC, HW, BC, FAC, WINC, WT, DLO1, FAC1, RJFAC
C
...
C
      IF (JHI + 1 - NFT2 > 0) THEN
        SMOOTH(NFT2 + 1) = EXP(-FAC1 * FLOAT(NFT2)**2) * FT(NFT2 + 1)
      ELSE IF (JHI + 1 - NFT2 .EQ. 0) THEN
        SMOOTH(NFT2 + 1) = ZERO
      ELSE
        J2LO = JHI + 2
        DO 22 J1 = J2LO, NFT2
...
C
      ...
      double precision X(M), Z, AN, BN, CN, DN, BSIN, BCOS,
     *      UN, VN, XN, YN, SAVE1
...
C
      implicit integer (I-N) 
      double precision X(M), AN, BN, PN, QN, Z, DN,CN,UN,SAVE1,
     *      BCOS, BSIN, VN
...
c
      implicit integer (i-n) 
      double precision xreal(n), ximag(n), tempr, 
     *    xs0, xs1, xs2, xs3, ys0, ys1, ys2, ys3, sw1, cw1,
     *    x1,y1,x2,y2,x3,y3,cw3,sw3, cw2,sw2,z,bcos,bsin
          ...
          do 916 j5 = j4, l5, l4
           do 915 j6 = j5, l6, l5
            do 914 j7 = j6, l7, l6
             do 913 j8 = j7, l8, l7
              do 912 j9 = j8, l9, l8
               do 911 j10 = j9, l10, l9
                do 910 j11 = j10, l11, l10
                 do 909 j12 = j11, l12, l11
                  do 908 j13 = j12, l13, l12
                   do 907 j14 = j13, l14, l13
                    do 906 j15 = j14, l15, l14
                     do 905 j16 = j15, l16, l15
                      do 904 j17 = j16, l17, l16
                       do 903 j18 = j17, l18, l17
                        do 902 j19 = j18, l19, l18
                         j20 = j19
                         do 901 i = 1, 2
                           ii = ii + 1
                           if (ii .lt. j20) then
